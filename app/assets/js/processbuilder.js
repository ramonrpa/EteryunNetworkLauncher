...
class ProcessBuilder {
                ...
                if (argDiscovery.test(args[i])) {
                    ...
                    switch (identifier) {
                        ...
                        case 'natives_directory':
                            ...
                            break
                        case 'launcher_name':
                            val = args[i].replace(argDiscovery, 'Eteryun-Network-Launcher')
                            break
    ...
    classpathArg(mods, tempNativePath) {
        ...
        if (this.server.mainJar)
            cpArgs.push(path.join(this.commonDir, this.server.mainJar))
        else
