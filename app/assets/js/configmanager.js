...
// TODO change
const dataPath = path.join(sysRoot, '.EteryunNetworkLauncher')
 ...
 * @param {boolean} play
 */
exports.setPlay = function (play) {
    config.settings.music.play = play
}
 ...
 * @returns {boolean}
 */
exports.getPlay = function (def = false) {
    return !def ? config.settings.music.play : DEFAULT_CONFIG.settings.music.play
}
...
exports.setVolume = function (volume) {
    config.settings.music.volume = Number.parseFloat(volume)
}
 ...
 * @returns {number}
 */
exports.getVolume = function (def = false) {
    return !def ? config.settings.music.volume : DEFAULT_CONFIG.settings.music.volume
}
